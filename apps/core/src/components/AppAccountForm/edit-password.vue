...
const form = useForm({
  validationSchema: toTypedSchema(
    z.object({
      password: z.string().min(1, 'obligatoire'),
      newPassword: z.string().min(1, 'minimum 6 caractères').min(6, 'Le mot de passe doit être entre 6 et 18 caractères').max(18, 'maximum 18 caractères'),
