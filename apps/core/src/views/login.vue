...
<template>
  ...
  <div class="text-base p-1 border rounded-lg bg-background flex-center right-4 top-4 absolute z-1">
    <FaDropdown
      ...
      :items="[[
        { label: 'Gauche', disabled: layoutAlign === 'left', handle: () => { layoutAlign = 'left' } },
        { label: 'Centrer', disabled: layoutAlign === 'center', handle: () => { layoutAlign = 'center' } },
        { label: 'Droite', disabled: layoutAlign === 'right', handle: () => { layoutAlign = 'right' } },
      ]]"
    >
