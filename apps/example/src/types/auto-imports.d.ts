...
declare global {
  ...
  const useAppOfflineStore: typeof import('../store/modules/app/offline').useAppOfflineStore
  ...
  const useClientNameLookup: typeof import('../composables/useClientNameLookup').useClientNameLookup
  ...
  const useFirestoreAction: typeof import('../composables/useFirestoreAction').useFirestoreAction
  const useId: typeof import('vue').useId
  const useJuridictionFromMotif: typeof import('../composables/useJuridictionFromMotif').useJuridictionFromMotif
  ...
  const usePaiementsRealtime: typeof import('../composables/usePaiementsRealtime').usePaiementsRealtime
  const useRoute: typeof import('vue-router').useRoute
  const useRouter: typeof import('vue-router').useRouter
  const useSlots: typeof import('vue').useSlots
  const useSpellCheck: typeof import('../composables/useSpellCheck').useSpellCheck
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { ClientMatchSource } from '../composables/useClientNameLookup'
  import('../composables/useClientNameLookup')
}
