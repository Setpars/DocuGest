...
const itemTitleMap: Record<string, string> = {
  'global.system': 'Afficher les informations système',
  'global.search': 'Ouvrir la recherche de navigation',
  'nav.next': 'Menu principal suivant',
  'nav.prev': 'Menu principal précédent',
  'tabbar.prev': 'Onglet précédent',
  'tabbar.next': 'Onglet suivant',
  'tabbar.close': 'Fermer l’onglet actuel',
  'tabbar.n': 'Aller à l’onglet n',
  'tabbar.last': 'Aller au dernier onglet',
} as const
...
<template>
  <FaModal v-model="isShow" title="Raccourcis clavier" :footer="false">
    <div class="px-4">
